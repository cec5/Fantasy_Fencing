...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['addCompetitionDataSubmit'])) {
	...
	$compID = $_POST['compID'];
	$result = FIEScraperService::scrapeCompetitionData($season, $compID);
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['updateCompetitionResultsSubmit'])) {
	...
	$result = FIEScraperService::scrapeCompetitionResults($season, $compID);
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['addCompetitionAthletesSubmit'])) {
	...
	$athletes = FIEScraperService::scrapeAthletesCompetition($season, $compID);
...
<main class="container my-5">
	...
	<form method="POST" action="admin/adminCompetitions.php" class="mb-4">
		...
		<button type="submit" class="btn btn-primary" name="updateCompetitionResultsSubmit">Update Competition
			Results</button>
	</form>
	...
	<form method="POST" action="admin/adminCompetitions.php">
		...
		<button type="submit" class="btn btn-primary" name="addCompetitionAthletesSubmit">Add Competition
			Athletes</button>
	</form>
</main>
