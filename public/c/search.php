...
$competitions = CompetitionService::getCompetitions($season, $weapon, $gender, $ageCategory);
?>
		...
		<tbody>
			<?php foreach ($competitions as $competition): ?>
				<tr>
					...
					<td><a
							href="c/competition.php?season=<?= $competition['season'] ?>&id=<?= $competition['competitionId'] ?>"><?= htmlspecialchars($competition['name']) ?></a>
					</td>
					<td><?= htmlspecialchars($competitionCategories[$competition['category']] ?? $competition['category']) ?>
					</td>
