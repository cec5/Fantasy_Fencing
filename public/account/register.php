<?php
require_once(dirname(__DIR__) . '/../backend/src/AuthService.php');
require_once(dirname(__DIR__) . '/../backend/src/dataArrays.php');
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
	...
	$result = AuthService::registerUser($username, $email, $nationality, $password);
