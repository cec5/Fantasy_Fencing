...
if (isset($_COOKIE['auth_token'])) {
	$validationResult = AuthService::validateToken($_COOKIE['auth_token']);
	if ($validationResult['success']) {
		$userId = $validationResult['userId'];
		$userIsAdmin = AuthService::isAdmin($userId); // Check if the user is an admin
	}
}
?>
<!-- header.php -->
					...
					<ul class="navbar-nav me-auto">
						...
						<li class="nav-item dropdown">
							<a class="nav-link dropdown-toggle" href="#" id="athleteDropdown" role="button"
								data-bs-toggle="dropdown" aria-expanded="false">View Athletes</a>
						...
						<!-- Fantasy Dropdown -->
						<li class="nav-item dropdown">
							<a class="nav-link dropdown-toggle" href="#" id="fantasyDropdown" role="button"
								data-bs-toggle="dropdown" aria-expanded="false">Fantasy</a>
						...
						<?php if ($userIsAdmin): ?>
							<li class="nav-item dropdown">
								...
								<ul class="dropdown-menu dropdown-menu-end" aria-labelledby="adminDropdown">
									...
									<li><a class="dropdown-item" href="admin/adminCompetitions.php">Manage Competitions</a>
									</li>
								</ul>
							</li>
						<?php endif; ?>
