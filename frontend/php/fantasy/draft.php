...
// Handle athlete search (ONLY when a search is made)
$searchResults = [];
...
<body>
    	<div class="container mt-5">
        	...
        	<h3 class="mt-5">Your Selected Athletes</h3>
        	<?php if ($isLocked): ?>
            		<p class="text-danger">This competition is locked. No changes can be made.</p>
        	<?php endif; ?>
        	...
        	<table class="table table-sm table-striped table-bordered text-center">
            		<thead>
                		<tr>
                    			...
                    			<th>Name</th>
                    			<th>Nationality</th>
                   			<?php if (!$isLocked): ?><th>Action</th><?php endif; ?>
               			</tr>
            		</thead>
		    	<tbody>
		        	<?php for ($i = 0; $i < 5; $i++): ?>
		            		<tr>
		                		...
		                		<?php if (isset($selections[$i])): ?>
		                   			<td><?= htmlspecialchars($selections[$i]['name']) ?></td>
		                    			<td><?= htmlspecialchars($validCountryCodes[$selections[$i]['nationality']] ?? $selections[$i]['nationality']) ?></td>
		                    		<?php if (!$isLocked): ?>
				                	<td>
        	...
        	<?php if (!$isLocked): ?>
           	 	...
           	 	<!-- Display Search Results (Only If Searched) -->
